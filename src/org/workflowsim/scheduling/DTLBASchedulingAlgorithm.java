 ...
 * @author HaoLee
 */
public class DTLBASchedulingAlgorithm extends BaseSchedulingAlgorithm {

    public DTLBASchedulingAlgorithm() {
        super();
    }
    ...
    public void run() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            String vm_class = predictRequestDT(cloudlet);
    ...
    public String predictRequestDT(Cloudlet req) {
        ...
        try {
            ...
            double preNB = rt.classifyInstance(newInst);
