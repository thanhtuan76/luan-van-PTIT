...
public abstract class BaseSchedulingAlgorithm implements SchedulingAlgorithmInterface {
    ...
    private List<? extends Vm> vmListWithOrder; // for usage
    /**
    ...
    public void setVmListWithOrder(List list) {
        this.vmListWithOrder = new ArrayList(list);
    }
    ...
    public List getVmListWithOrder() {
        return this.vmListWithOrder;
    }
