...
import org.workflowsim.scheduling.MaxMinProposedSchedulingAlgorithm;
...
import org.workflowsim.scheduling.MCCVASchedulingAlgorithm;
import org.workflowsim.scheduling.ACTPASchedulingAlgorithm;
import org.workflowsim.scheduling.PDOASchedulingAlgorithm;
import org.workflowsim.scheduling.RCBASchedulingAlgorithm;
    ...
    private BaseSchedulingAlgorithm getScheduler(SchedulingAlgorithm name) {
        ...
        switch (name) {
            ...
            case MAXMIN:
                ...
                break;
            case MAXMIN_PROPOSED:
                algorithm = new MaxMinProposedSchedulingAlgorithm();
                break;
            case MCCVA:
                algorithm = new MCCVASchedulingAlgorithm();
                break;
            case PDOA:
                algorithm = new PDOASchedulingAlgorithm();
                break;
            case ACTPA:
                algorithm = new ACTPASchedulingAlgorithm();
                break;
            case MCT:
            ...
            case ROUNDROBIN:
                ...
                break;
            case RCBA:
                algorithm = new RCBASchedulingAlgorithm();
                break;
            default:
                algorithm = new StaticSchedulingAlgorithm();
                break;
