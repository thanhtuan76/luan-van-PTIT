...
public class ArimaDatacenterBroker extends SimEntity {
     ...
     */
    protected List<? extends VmExt> vmList;

    /**
     * The list of VMs created by the broker.
     */
    protected List<? extends VmExt> vmsCreatedList;
     ...
     */
    protected List<? extends CloudletExt> cloudletList;

    /**
     * The list of submitted cloudlets.
     */
    protected List<? extends CloudletExt> cloudletSubmittedList;

    /**
     * The list of received cloudlet.
     */
    protected List<? extends CloudletExt> cloudletReceivedList;
     ...
     * @post $none
     */
    public ArimaDatacenterBroker(String name) throws Exception {
        super(name);
        LastRT = new ArrayList<Double>();
        setVmList(new ArrayList<VmExt>());
        setVmsCreatedList(new ArrayList<VmExt>());
        setCloudletList(new ArrayList<CloudletExt>());
        setCloudletSubmittedList(new ArrayList<CloudletExt>());
        setCloudletReceivedList(new ArrayList<CloudletExt>());
     ...
     */
    public void submitCloudletList(List<? extends CloudletExt> list) {
     ...
     * @see #submitCloudletList(java.util.List)
     */
    protected void submitCloudletsOld() {
        int vmIndex = 0;
     ...
     */
    protected <T extends VmExt> void setVmList(List<T> vmList) {
        this.vmList = vmList;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public <T extends CloudletExt> List<T> getCloudletList() {
     ...
     */
    protected <T extends CloudletExt> void setCloudletList(List<T> cloudletList) {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T extends CloudletExt> List<T> getCloudletSubmittedList() {
     ...
     */
    protected <T extends CloudletExt> void setCloudletSubmittedList(List<T> cloudletSubmittedList) {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T extends CloudletExt> List<T> getCloudletReceivedList() {
     ...
     */
    protected <T extends CloudletExt> void setCloudletReceivedList(List<T> cloudletReceivedList) {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T extends VmExt> List<T> getVmsCreatedList() {
     ...
     */
    protected <T extends VmExt> void setVmsCreatedList(List<T> vmsCreatedList) {
