...
public class CloudSimWebExample {
    ...
    public static void main(final String[] args) throws SecurityException, IOException {
        ...
        try (InputStream is = Files.newInputStream(Paths.get(System.getProperty("user.dir")+"/data/customlog1.txt"))) {
            props.load(is);
        }
        ...
        try {
            ...
            WebBroker broker = new WebBroker("Broker", 5, 100, datacenter0.getId());
            ...
            List<WebSession> sessions = generateRandomSessions(broker, 1);
