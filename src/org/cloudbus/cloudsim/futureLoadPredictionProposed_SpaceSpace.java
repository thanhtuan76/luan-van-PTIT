 ...
 * @author Admin
 */
public class futureLoadPredictionProposed_SpaceSpace {
    ...
    public static void main(String[] args) {
        int nCloudlets =900;
        Log.printLine("Starting Demo... [Proposed Future Load Prediction] Space-Space ");
    ...
    public static futureLoadPredictionProposed createBroker(String name) {
        ...
        try {
            broker = new futureLoadPredictionProposed(name, 1);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
