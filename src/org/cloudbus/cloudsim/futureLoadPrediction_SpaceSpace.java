...
import org.cloudbus.cloudsim.futureLoadPrediction;
 ...
 * @author Admin
 */
public class futureLoadPrediction_SpaceSpace {
    ...
    public static void main(String[] args) {
        int nCloudlets = 100;
        Log.printLine("Starting Demo... [Future Load Prediction] Space-Space ");
        ...
        try {
            ...
            futureLoadPrediction broker = createBroker("Broker_0");
    ...
    public static futureLoadPrediction createBroker(String name) {

        futureLoadPrediction broker = null;
        try {
            broker = new futureLoadPrediction(name, 1);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
