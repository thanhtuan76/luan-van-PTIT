...
import org.cloudbus.cloudsim.activeVmOrigin;
 ...
 * @author Admin
 */
public class activeVmOrigin_SpaceSpace {
 ...
 /*/Nếu id của VM < 2 thì SpaceShared, còn lại TimeShared
    ...
    public static void main(String[] args) {
        int nCloudlets = 100;
        Log.printLine("Starting Demo... [Active Vm Origin] Space-Space ");
        ...
        try {
            ...
            activeVmOrigin broker = createBroker("Broker_0");
     ...
     */
    public static activeVmOrigin createBroker(String name) {

        activeVmOrigin broker = null;
        try {
            broker = new activeVmOrigin(name);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
